...
if ($action === 'admin_save_settings') {
    ...
    if(isset($input['swapwallet_application'])) set_setting('swapwallet_application', trim((string)$input['swapwallet_application']));
